...
<div className="mt-4 grid flex-1 grid-rows-3 gap-4">
    ...
    >
      ...
      <div className="px-5 flex-1 space-y-1">
        ...
        <p className="text-xs leading-relaxed text-muted-text dark:text-dark-text-muted line-clamp-10">
          Personalized training drills and practice routines generated by AI to target weaknesses and accelerate improvement.
        </p>
      </div>
    </button>
    ...
    >
      ...
      <div className="px-5 flex-1 space-y-1">
        ...
        <p className="text-xs leading-relaxed text-muted-text dark:text-dark-text-muted line-clamp-10">
          Run timed practice sessions to build rhythm, focus, and consistency under realistic match conditions.
        </p>
      </div>
    </button>
    ...
    >
      ...
      <div className="px-5 flex-1 space-y-1">
        ...
        <p className="text-xs leading-relaxed text-muted-text dark:text-dark-text-muted line-clamp-10">
          Record your technique and receive structured feedback to refine mechanics and eliminate bad habits.
        </p>
      </div>
    </button>
  </div>
